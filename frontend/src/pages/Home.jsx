  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <section className="flex flex-col items-center text-center mt-10 mb-16">
        <h1 className="text-4xl md:text-5xl font-retro text-pokeRed mb-6 drop-shadow-[3px_3px_0px_#222224] leading-tight">
          ¡Atrapa a tu nuevo <br/> mejor amigo!
        </h1>
        <p className="text-xl md:text-2xl text-pokeDark mb-8 max-w-2xl font-bold">
        ...
        <Link 
          to="/animales" 
          className="bg-pokeBlue text-white text-xl font-retro px-8 py-4 rounded-full border-4 border-pokeDark hover:bg-pokeYellow hover:text-pokeDark hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#222224] transition-all"
        >
          Ver Adopciones
        </Link>
      </section>
