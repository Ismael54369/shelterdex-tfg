-- ShelterDex — Script de instalación compatible con Aiven
-- Fecha: 20/04/2026
-- Nota: PRIMARY KEY y AUTO_INCREMENT van inline porque Aiven
--       tiene sql_require_primary_key activado.
...
-- =====================
-- 3. CATÁLOGO DE TAREAS (incluye efecto_energia y efecto_sociabilidad)
-- =====================
...
CREATE TABLE `imagenes_animales` (
  ...
  CONSTRAINT `imagenes_animales_ibfk_1` FOREIGN KEY (`animal_id`) REFERENCES `animales` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `registro_tareas` (
  ...
  CONSTRAINT `registro_tareas_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `registro_tareas_ibfk_2` FOREIGN KEY (`animal_id`) REFERENCES `animales` (`id`) ON DELETE CASCADE,
  CONSTRAINT `registro_tareas_ibfk_3` FOREIGN KEY (`tarea_id`) REFERENCES `catalogo_tareas` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `solicitudes_adopcion` (
  ...
  PRIMARY KEY (`id`),
  KEY `animal_id` (`animal_id`),
  CONSTRAINT `solicitudes_adopcion_ibfk_1` FOREIGN KEY (`animal_id`) REFERENCES `animales` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
